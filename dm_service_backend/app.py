...
description = """
dm_service_backend API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="dm_service_backend",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://dm_service_backend.com/terms/",
    contact={
        "name": "Darwin939",
        "url": "http://dm_service_backend.com/contact/",
        "email": "Darwin939@dm_service_backend.com",
    },
    license_info={
        "name": "The Unlicense",
